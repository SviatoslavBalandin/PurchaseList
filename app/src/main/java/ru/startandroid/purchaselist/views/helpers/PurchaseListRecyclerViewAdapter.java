...
public class PurchaseListRecyclerViewAdapter extends RecyclerView.Adapter<PurchaseListRecyclerViewAdapter.GoodsListViewHolder> {
    ...
    class GoodsListViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.numberAndTitleOfPurchase)
        TextView numberAndTitleOfPurchase;

        @BindView(R.id.purchaseQuantity)
        TextView quantityOfPurchase;

        @BindView(R.id.purchasePrise)
        TextView priseOfPurchase;

        @BindView(R.id.purchaseCheckBox)
